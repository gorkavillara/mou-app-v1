...
- [ ] **IA-24** [P0] **Motor exacto contra el goniómetro** en todas las imágenes del cirujano (petición de Gorka 2026-09-16). (1) Bug de proporción: los ángulos se medían en coordenadas normalizadas, deformados según el aspecto de cada imagen/vídeo → ahora `toImagePixels` + ángulo 2D en el plano de imagen (el mejor de 4 métodos comparados). (2) Calibración por **tabla a tramos** que pasa por cada punto de goniómetro, con tabla propia del **pulgar**; DIP tope 80°→90°. Resultado: **15/15 fotos con error 0°** (`calibrate-from-photos.ts --check` + test) y sesión en vivo de Javi recto −3° / 90° → 90° (antes +28° / −30°). **Falta**: validación de Javi en iPhone y más sujetos/posturas (IA-21) — ver [[12-Convencion-angular]] #ia
